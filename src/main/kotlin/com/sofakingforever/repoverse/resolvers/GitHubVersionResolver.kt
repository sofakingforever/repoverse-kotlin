...
// "sofakingforever/kotlin-analytics"
class GitHubVersionResolver(override val packagePath: String) : RemoteVersionResolver {
    override fun resolve(callback: RemoteVersionResolver.Callback) {
        ...
        val request = Request.Builder()
                .url("https://github.com/$packagePath/releases/latest")
                .get()
                .build()
